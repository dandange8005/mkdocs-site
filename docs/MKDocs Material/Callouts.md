Or [Admonitions](https://squidfunk.github.io/mkdocs-material/reference/admonitions/) is a feature that allows you to create _call-outs_ type of content to enhance the documentation.
